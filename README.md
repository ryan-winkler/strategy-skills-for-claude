# 21 enterprise consulting skills for Claude Opus

Have you recently seen on LinkedIn this exact one-liner and people being told to comment just to unlock it?

> "We compiled 21 insane Enterprise McKinsey-style skills that push Opus to its limits and turn Claude into a MBB-grade consulting engine"

Here’s the cleaner version: these are 21 concrete work modes you can actually use.

A practical set of reusable workflows that turn Claude Opus into a serious strategy analysis and execution engine. This collection is independent and unofficial.

It focuses on concrete outputs: market sizing, competitive intelligence, financial analysis, operating model design, pricing and portfolio decisions, risk management, and executive recommendations.

## Tags

`strategy-consulting`, `market-sizing`, `competitive-intelligence`, `financial-modeling`, `executive-communication`, `operating-models`, `pricing-strategy`, `due-diligence`, `decision-memos`, `boardroom-ready`

## What This Is

This repository contains 21 standalone Claude skills for strategy work, grouped into six practical consulting domains. Each skill is a small, uploadable workflow that teaches Claude how to perform one high-value consulting task with a repeatable strategy-consulting method.
...
Use these when the team needs to understand the real problem before choosing a move. The style is strategy-consulting-inspired: fact base first, root cause discipline, explicit assumptions, and a clear question to answer.
...
```text
Use the narrative-builder skill to turn this recommendation into a strategy-consulting executive story.
```
